  ...
  >
    ...
    >
      <a-collapse-panel
        ...
        v-if="allgroup == 'Child Details' || allgroup == 'Treating Medical Specialist Details' || allgroup == 'Childs Condition'"
        ...
        >
          ...
          >
            <a-form @submit="complete">
              <div class="container">
                <div class="row">
                     <div v-if="alljsondata.groups === 'Child Details' && alljsondata.saveDetails == true">
                       <div v-for="data in dynamicField" :key="data">
                         <div class="row ">
                          <div class="col-md-4 ">
                            <a-input
    ...
    <a-collapse class="medical-eligble" >
      <a-collapse-panel header="Medical Eligibility" class="headingbullets"  >
        <a-form @submit="complete">
          <a-row>
            <a-col :lg="9" :md="9" :xs="24" class="inputfield">
            ...
            <a-col :lg="12" :md="12" :xs="24" class="inputfield">
              <a-form-item
          ...
          <a-row>
           ...
           <div class="container-fluid">
              <div class="hideondesktop">
                      <a-button class="next" id="openbutton" style="" @click="opensignature"> Signature </a-button>
                      </div>
                       <div class="text-danger hideondesktop" v-show="ischeck">
            ...
            <canvas id="sig-canvas" width="605" height="160" @mouseover="sign">
             ...
             <div
                ...
                <div class="hideondesktop">
                      <a-button class="next" @click="hidesignature">Submit</a-button>
                      </div>
                        </div>
                        </div>
    ...
    <a-col :lg="5" :md='8' :xs="12" class="complete-btn">
...
export default {
  ...
  created() {
    ...
    localStorage.setItem('mailloginurl',loginpath)
      ...
      fetch(
        ...
        .then((result) => {
          ...
          if (alldata.StatusCode == 200) {
            ...
            console.log(alldata.Record.FitForWish)
