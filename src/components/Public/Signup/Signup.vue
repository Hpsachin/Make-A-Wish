  ...
  >
    ...
    <div class="row justify-content-center">
      <div class="col-md-5 mb-3" style="position:relative">
        <!-- <a-form-item ref="name" name="fname"> -->
          <span><MehFilled /></span>
          <a-input
            size="large"
    ...
    <a-select-option value="Social Worker">Social Worker</a-select-option>
        ...
        <!-- <a-form-item ref="role" name="role"> -->
          <span><MehFilled /></span>
          <a-select
            size="large"
      ...
      <div class="text-lower">
        <!-- <a-col :span="24" align="center" >
          <div>
            <span style="color:white" >Already have an account <router-link to='/loginform'>Login?</router-link> </span>
          <a-anchor-link
      style="color:white"
      class="linkColor"
    />
      ...
      this.$refs.ruleForm
        ...
        // .then(() => {
          ...
          if (emailchecker == true && this.form.fname.trim() != '' && this.form.lname.trim() !='' && this.form.email !='' && this.form.password !='' && this.form.cpassword !='' && this.form.role !='') {
            ...
            // var raw = JSON.stringify({"FirstName":"vikas ","lastname":"singh","email":"a12tul@team.humanpixel.com.au","Role":"Medical Specialist","Password":"123"});
            ...
            fetch(
              ...
              // fetch("https://makeawishau--humanpixel.my.salesforce.com/services/apexrest/signupRestService", requestOptions)
