  ...
  <div v-if="this.status">
    <div class="logo">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 left MAW-logo">
            <img
    ...
    <div class="steps allforms">
      ...
      <div class="steps-content container-fluid">
                  ...
                  <div class="row justify-content-center mt-4 mb-5 mainWrapper">
                    ...
                    >
                      ...
                      <div
                        ...
                        "
                      >
                        <!-- <div v-if="steps[0][5].innerfield[0].value == 'Yes'">
                        ...
                        <div v-if="steps[0][4].innerfield[0].value == 'No'">
                          <div v-if="alldata.name == 'childs_address'">
                            <span
                              v-if="alldata.required === true"
                              class="required required-radio"
                      ...
                      <div
                        v-else-if="
                          ...
                          primaryrelation ===
                            ('Child' || 'Family Members' || 'Medical Team')
                        "
                      >
                        <!-- <span v-if="alldata.required === true" class="required"
                          >*</span
        ...
        <a-dropdown :placement="placements" v-if="this.current > 1">
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <div class="col-md-12 text-center">
              ...
              <!-- <h3 class="text-white pt-3">Redirecting in 1 second...</h3> -->
            </div>
          </div>
        </div>
      </a-modal>
...
export default {
  ...
  created() {
    ...
    //   this.$router.push("/newApplicationForm");
    // }
  ...
  methods: {
    ...
    disabledDate(current) {
      // console.log(current);
      return current && current > moment().endOf("03-07-2018");
    },
    // isLetter(e) {
    //   var fieldcheck1 = true;
    //   for (let j = 0; j < this.steps[0][this.current].innerfield.length; j++) {
    //     if (this.steps[0][this.current].innerfield[j].includeNumber === true) {
    //       fieldcheck1 = true;
    //     }
    //   }
    ...
    getdata(current) {
      this.axios
        ...
        .then((res) => {
          ...
          //  console.log(res.data.ReferralSignature)
    ...
    next(done) {
      ...
      //     console.log(store.state.signdata);
      //     sigImage.setAttribute("src", dataUrl);
      //   },
      //   false
      // );
      ...
      for (let j = 0; j < this.steps[0][this.current].innerfield.length; j++) {
        if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map1").value;
          if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map2").value;
          if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map3").value;
          if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map4").value;
          if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map5").value;
          if (
          ...
          this.steps[0][this.current].innerfield[
            j
          ].value = document.getElementById("map6").value;
          if (
         ...
         this.primaryrelation === "Legal Guardian" &&  this.steps[0][this.current].innerfield[j].name == "parent_signature"
          ...
          this.primaryrelation === ("Child" ||
            "Family Members" ||
            "Medical Team") && this.steps[0][this.current].innerfield[j].name == "referral_signature"
        ) {
          console.log('child')
    ...
    handleSubmit() {
      //  if(this.current == this.steps[0].length-1){
      //       var x = document.getElementById('sig-dataUrl').innerHTML.value
      //       this.ReferralSignature = x
      //    this.steps[0].in = x.innerHTML
