  ...
  <div class="steps allforms">
    ...
    <div class="steps-content container-fluid">
              ...
              >
                ...
                <div class="row justify-content-center mt-4 mb-5">
                  ...
                  >
                    ...
                    <div v-else-if="alldata.type == 'text'">
                      <a-input
                        class="mt-3 mb-3"
                    ...
                    <div v-else-if="alldata.type == 'number'">
                      <a-input
                        class="mt-3 mb-3"
                        v-model:value="alldata.value"
                        :placeholder="alldata.placeholder"
                    ...
                    <div v-else-if="alldata.type == 'email'">
                      <a-input
                        class="mt-3 mb-3"
                        :placeholder="alldata.placeholder"
                        v-model:value="alldata.value"
      ...
      <a-drawer
        ...
        @close="onClose"
      >
        <a-steps class="side" @change="same" :current="current">
          <a-step v-for="item in steps" :key="item" :title="item.content">
          </a-step>
        </a-steps>
...
export default {
  ...
  created() {
    this.isLoading = true;
    console.log("caseworkercomponent" + JSON.stringify(store.state.something));
  },
  mounted() {
    this.getdata();
