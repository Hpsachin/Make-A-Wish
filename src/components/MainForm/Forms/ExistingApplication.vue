...
<Father  :data="jsondata" :applicationNO='this.existingform.applicationNO' :relation='this.relation' :dyField='this.dynamicField' :fHName='this.firstHeadingName'/>
</div>
<div v-else>
<div>
  <div class="logo">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6 refresh text-right reset">
          ...
          /> -->
          <a-button @click='resetForm'><img src="https://phpstack-371465-1221944.cloudwaysapps.com/img/img2.svg"/> </a-button>
    ...
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-10 col-md-8 col-10 formMainDiv">
          <h2 class="heading">Please complete the below details to continue with your application.</h2>
          <a-form
            ref="ruleForm"
            :model="existingform"
            :rules="rules"
          ...
          >
            <div class="row">
              <div class="col-md-6">
                <div>
                    <a-form-item ref="name" name="name" @keyup="validatespace()" >
                  ...
                  <div
                      ...
                      <div style="display:none; color:#dc3545;" class="ant-form-explain"   id="namespace">Please Fill first Name </div>
                     </a-form-item>
                </div>
              </div>
              <div class="col-md-6 ">
                <div>
                     <a-form-item ref="applicationNO" name="applicationNO" @keyup="applicationmessage()">
                         <span class="required">*</span>
                  <a-input
                  ...
                  <div
                     ...
                     <!-- <p style="display:none; color:red; font-size:10px"   id="appspace">Space Not Allow </p> -->
                    <div style="color:red; display:none;"  id="number" class="ant-form-explain">  Please Fill the Correct Number </div>
                   </a-form-item>
                </div>
              </div>
              <div class="col-md-12 w-100">
                <a-form-item ref="email" name="email" @keyup="chechmail()" class="w-100">
                    <span class="required">*</span>
                  <a-input
                  ...
                  <div style="color:#dc3545; display:none; " class="ant-form-explain" id="emailid">Please Fill The Valid Email Address </div>
                </a-form-item>
              </div>
     ...
     else
{
   if(filter.test(this.existingform.email)){
    ...
    onSubmit() {
     ...
     var raw = JSON.stringify({"Dashboard": false,"FirstName":this.existingform.name,"Email":this.existingform.email,"ApplicationNumber":this.existingform.applicationNO});
      var requestOptions = {
      method: 'POST',
      headers: myHeaders,
      body: raw,
     ...
     .then(result =>{
          ...
          if(EXDATA.StatusCode==200){
              //  console.log(EXDATA.primaryContactName);
