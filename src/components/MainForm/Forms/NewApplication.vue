                ...
                <div class="col-md-6 text">
                 ...
                 <div class="col-md-6 text">
                  <a-form-item ref="Phone" name="Phone">
                    ...
                    <div id="mobileid" style="display: none" class="text-danger">
                      Not A Valid Number
                    </div>
                  </a-form-item>
                </div>
...
if (this.form.Mobile == "") {
      ...
      if (this.form.Mobile.toString().length === 10) {
        ...
        document.getElementById("mobileid").style.display = "block";
      }
    },
    chechmail() {
    ...
    handleSubmit() {
      ...
      if (this.ischeck === true) {
        ...
        var mobilecheck =this.checkmobilelength();
        if (
          emailchecker == true &&
